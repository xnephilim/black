...
// RANDAO implementation. See https://github.com/black/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		...
		GasLimit:    blacktypes.BlockGasLimit(ctx),
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := blacktypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(ctx sdk.Context,
	...
	// for more info https://github.com/black/ethermint/issues/1085
