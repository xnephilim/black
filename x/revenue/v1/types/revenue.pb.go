...
// source: black/revenue/v1/revenue.proto
...
func init() {
	proto.RegisterType((*Revenue)(nil), "black.revenue.v1.Revenue")
}

func init() { proto.RegisterFile("black/revenue/v1/revenue.proto", fileDescriptor_33d087165192e447) }
