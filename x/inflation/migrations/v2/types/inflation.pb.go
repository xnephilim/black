...
// The initial V2InflationDistribution can be calculated from the Black Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "black.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "black.inflation.v1.V2ExponentialCalculation")
}
