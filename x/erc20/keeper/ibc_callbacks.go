...
// registered via governance. Note that the native staking denomination (e.g. "ablack"),
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on Black need to have their tokens in the
