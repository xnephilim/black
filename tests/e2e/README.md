...
```log
ok  	github.com/black/black/v9/tests/e2e	174.137s.
```
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/black/black/v10/cmd/black/root.go:243 +0x2ca
        ...
        main.main()
            github.com/black/black/v10/cmd/black/main.go:20 +0x45
