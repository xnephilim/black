...
# Initialize chain.
black init test --chain-id black_9000-2
...
export BLACK_P2P_MAX_NUM_INBOUND_PEERS=200
export BLACK_P2P_MAX_NUM_OUTBOUND_PEERS=200
export BLACK_STATESYNC_RPC_SERVERS="https://black-rpc.polkachu.com:443,https://rpc-black-ia.notional.ventures:443"
