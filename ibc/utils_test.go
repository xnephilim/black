...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/ablack",
			"10",
			sdk.Coin{Denom: "ablack", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped ablack coin",
			"ablack",
			"10",
			sdk.Coin{Denom: "ablack", Amount: sdk.NewInt(10)},
		},
		{
			"get ibc wrapped ablack coin",
			"transfer/channel-0/ablack",
			"10",
			sdk.Coin{Denom: teststypes.AblackIbcdenom, Amount: sdk.NewInt(10)},
		},
		{
