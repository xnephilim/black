...
Please refer to the official Black [bug bounty program](https://immunefi.com/bounty/black/)
...
- Use the Black [bug bounty program](https://immunefi.com/bounty/black/) on Immunefi to disclose all vulnerabilities,
...
Black uses the following disclosure process:
...
2. The team determines the vulnerability’s potential impact on Black.
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Black in a
    ...
    4. The nodes and validators update their Black and Ethermint dependencies to use these releases.
    5. A week (or less) after the security vulnerability has been patched on Black,
...
The payment process will be executed according to Black’s Immunefi Bug Bounty program Rules.

### Contact

The Black Security Team is constantly being monitored.
If you need to reach out to the team directly,
please reach out via email: [security@black.org](mailto:security@black.org)
